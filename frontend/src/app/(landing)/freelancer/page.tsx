...
export const metadata: Metadata = {
  ...
  description: "Earn money by using your own skills",
};
  ...
  const howCards: Record<string, Array<Omit<HowCardProps, "index">>> = {
    firstSection: [
      ...
      },
      {
        ...
        title: "Get paid",
        paragraph:
          "Once the client approved your delivery, you will get paid, which means the money will be sent and added to your balance in WorkSphere, so you can withdraw it with the method you want, by the payment method you desire.",
      },
    ],
    secondSection: [
      {
      ...
      <div className="flex flex-col gap-[200px] max-md:gap-[120px]">
        <section className="h-screen bg-black flex items-center rounded-b-[36px] relative overflow-hidden">
          {[1, 2, 3].map((imageId, i) => (
            <Image
              key={i}
              src={`/landing/hero/freelancer/${imageId}.png`}
              alt="Background"
              width={1000}
              height={1000}
          ...
          <div className="landing-container mx-auto z-[2]">
            <div className="flex flex-col col-span-6 max-xl:col-span-4 max-md:col-span-full [&_*]:text-white gap-5">
              ...
              <p className="font-secondary text-white text-[21.33px] max-md:text-lg tracking-[0.4px] mb-10">
                Unlock opportunities to earn reliable income, all while working
                from home.
              </p>
