"use client";
import { UserRole, useUserStore } from "@/store/store";
      ...
      <div className="flex max-md:flex-col gap-5">
        ...
        >
          ...
          <p className="text-lg group-hover:text-white duration-300">
            Hire reliable freelancers from around the globe to work on your
            projects.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-lg group-hover:text-white duration-300">
            Work as a freelancer on projects of various categories and get paid.
          </p>
        </Link>
      </div>
