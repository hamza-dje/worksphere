    ...
    return (
        <>
            ...
            <CardWrapper header={"Skills/Services Ratio"}>
                <div className="flex flex-col justify-between max-sm:gap-3 flex-1 mt-1">
                    <div className="flex gap-1.5">
                        {
                            skillsAsNumber.map((skill, i) => <span key={i}
            ...
            <div className="flex flex-col gap-2 max-lg:col-span-full max-lg:flex-row">
                ...
                >
                    <div
                        className="font-primary font-bold text-4xl text-primary flex items-center gap-2 max-sm:text-2xl">
                        25
                        <div className={`w-9 max-sm:w-6 aspect-square rounded-full flex items-center justify-center
                                ${positive
                                ? 'bg-green'
