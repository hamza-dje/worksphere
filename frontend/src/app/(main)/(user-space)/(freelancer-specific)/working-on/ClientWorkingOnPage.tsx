...
export default function ClientWorkingOnPage() {
  return (
    <>
      <NumberCard
        ...
        customFooter={
          <div className="flex justify-between">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-primary text-xs opacity-20">No delay</span>
            </div>
          </div>
        }
      />
      ...
      >
        <MessageCard
          ...
          messagesCount={2}
        />
        <p className="font-primary text-xs opacity-20 self-end">Go to inbox</p>
      </CardWrapper>
