...
export default function Notification(props: NotificationProps) {
    return (
        <div className={`px-5 py-3 cursor-pointer ${props.notChecked ? 'bg-[oklch(from_var(--color-primary)_l_c_h_/_0.15)] hover:bg-[oklch(from_var(--color-primary)_l_c_h_/_0.25)]' : 'hover:bg-[oklch(from_var(--color-primary)_l_c_h_/_0.08)]'} duration-200 transition-colors group`}>
