    ...
    return (
        <div className="flex-1 flex flex-col">
            <div className="flex gap-5 pb-10">
                ...
                />
                <span
                    className="bg-gradient-to-r from-blue to-green font-primary font-bold text-4xl bg-clip-text text-transparent">
                    Inbox
                </span>
            </div>
            ...
            <div className="flex-1 shadow rounded-4xl flex flex-col min-h-0 overflow-hidden">
                ...
                <div className="relative p-5">
                    ...
                    />
                    <label htmlFor="search" className="absolute top-1/2 -translate-y-1/2 right-9">
